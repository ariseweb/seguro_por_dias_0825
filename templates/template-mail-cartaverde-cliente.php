...
<head>
    ...
    <![endif]-->
    <style type="text/css">
        a:link { color: #644bf1; text-decoration: underline; }
    </style>
    <style type="text/css">
        h4 { text-align: left; }
        @media screen {
                ...
                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="600" align="center" class="r0-o" style="table-layout: fixed; width: 600px;">
                    <tr>
                        <td valign="top" class="r1-i" style="background-color: #ffffff;">
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="center" class="r3-o" style="table-layout: fixed; width: 100%;">
                                <tr>
                                    <td class="r8-i" style="padding: 0 0 20px;">
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                            <tr>
                                                <th width="100%" valign="top" class="r5-c" style="font-weight: normal;">
                                                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r6-o" style="table-layout: fixed; width: 100%;">
                                                                                        ...
                                                                                        <div>
                                                                                            <p style="margin: 15px 0 0 0;">
                                                                                                <span style="color: #333333;">
                                                                                                    ¡Estimado '.$nombre_tomador.',
                                                                                                </span>
                                                                                            </p>
                                                                                            <p style="margin: 15px 0 0 0;">
                                                                                                <span style="color: #333333;">
                                                                                                    Este documento se emite manualmente y se envía dentro de las 24h siguientes a su emisión, salvo aquellas pólizas emitidas los viernes a partir de las 14h que se emitirán el lunes si no es festivo. El documento se te enviará a este email.
                                                                                                </span>
                                                                                            </p>
                                                                                            <p style="margin: 15px 0 0 0;">
                                                                                                <span style="color: #333333;">
                                                                                                    Si es muy urgente o no las recibes en el plazo indicado la puedes solicitar en el teléfono <strong>917373810</strong> indicando la matrícula o el número de póliza <strong>'.$idVenta.'</strong>.
                                                                                                </span>
                                                                                            </p>
                                                                                            <p style="margin: 15px 0 0 0;">
                                                                                                <span style="color: #333333;">
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="center" class="r3-o" style="table-layout: fixed; width: 100%; margin-top:30px;">
                                <tr>
                                                                            ...
                                                                            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r10-o" style="table-layout: fixed; width: 100%;">
                                                                                <tr>
                                                                                    <td align="center" valign="top" class="r18-i nl2go-default-textstyle" style="font-family: Space Grotesk, Arial; word-break: break-word; color: #3b3f44; font-size: 18px; line-height: 1.5; padding-top: 15px; text-align: center;">
                                                                                        <div>
                                                                                            <p style="margin: 0;">
                                                                                                <span style="color: #009696;">
                                                                                                    <strong>'.WPCONFIG_NAME_EMPRESA.'</strong>
                                                                                                </span>
                                                                                            </p>
                                                                                        </div>
                                                                                    </td>
                                                                        ...
                                                                        <td class="r16-c nl2go-default-textstyle" align="left" style="color: #004481; font-family: Space Grotesk, Arial; font-size: 16px; line-height: 1.5; padding: 15px 0; text-align: left;">
                                                                            <div style="text-align: center;">
                                                                                <p style="margin: 0; color: #333; font-size: 15px;">
                                                                                    '.WPCONFIG_DIRECCION_EMPRESA.'
                                                                                </p>
                                                                                <p style="margin: 0;">
                                                                                    <a href="mailto:'.WPCONFIG_MAIL_EMPRESA.'" style="color: #644bf1; text-decoration: underline; font-size: 15px;">
                                                                                        '.WPCONFIG_MAIL_EMPRESA.'
                                                                                    </a>
                                                                                </p>
                                                                                <p style="margin: 0; color: #333; font-size: 15px;">
                                                                                    '.WPCONFIG_TELEFONO_EMPRESA.'
                                                                                </p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                            ...
                            <div align="center" style="font-family: Space Grotesk, Arial; word-break: break-word; color: #727272; font-size: 12px; line-height: 1.25; margin-top: 15px; text-align: center;">
